...
import { getCarFix, payAmount } from "../../redux/carFix";
...
const Pay = ({ id, pageSize, garage_id,disabled }) => {
    ...
    const garagesMenu = useSelector((state) => state.selectMenu.garagesMenu.data) || [];
...
const handleClickOpen = () => {
    ...
    const handleSubmit = async (values) => {
        ...
        await dispatch(payAmount(data)).then((res) => {
            ...
            dispatch(getCarFix({id:garage_id, pageSize:pageSize})) && handleClose() : setOpen(true)
        })
  };
  ...
  return (
    <Box>
      <EditButton disabled={disabled} backGround={colors.blueAccent[500]} onClick={handleClickOpen} text={t("pay")} />
      <Dialog
        fullWidth={true}
      ...
      >
            ...
            
        {
            ...
            {!garage_id ? (
                <CustomSelectMenu lable="Select_garage"
                options={garagesMenu} placeholder={t("Select_garage")}
